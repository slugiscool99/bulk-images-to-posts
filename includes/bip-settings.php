			    ...
			    <h3 class="hndle"><span><?php _e('Post Status','bulk-images-to-posts'); ?></span></h3>
			        <div class="inside">
			                <select id="bip-post-status" name="bip_post_status">
			                    <option value="publish" <?php echo get_option('bip_post_status','publish') == 'publish' ? ' selected="selected"' : '';?>>
			                        publish
			                    </option>
			                    <option value="draft" <?php echo get_option('bip_post_status','publish') == 'draft' ? ' selected="selected"' : '';?>>
			                        draft
			                    </option>
			                </select>
			    </div>
			    ...
			    <h3 class="hndle"><span><?php _e('Post Type','bulk-images-to-posts'); ?></span></h3>
			        <div class="inside">
			                <select id="bip-post-type" name="bip_post_type">
			                    <option value="post" <?php echo get_option('bip_post_status','post') == 'post' ? ' selected="selected"' : '';?>>
			                        post
			                    </option>
			                    <option value="page" <?php echo get_option('bip_post_status','post') == 'page' ? ' selected="selected"' : '';?>>
			                        page
			                    </option>
